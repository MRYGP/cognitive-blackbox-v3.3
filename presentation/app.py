...
# Version: v3.3 (Genesis Mode - FINAL & CORRECTED v15)
# Author: Hoshino AI PM
# This version fixes the NameError by correctly importing all dependencies
...
# --- Core Dependencies (THE FIX IS HERE) ---
# We import everything at the top level to ensure all names are defined
...
# =============================================================================
# ... (All functions from initialize_state to render_act_view remain the same)
